...
```mermaid
graph TD
    Client[Client Apps] --> Proxy[API Gateway / Proxy]
    
    subgraph Future State
    Proxy -- /api/v1/payments --> Payments[Payments Microservice]
    end

...
flowchart LR
    ...
    Client -- "1. Issue Command (e.g. CreateOrder)" --> CmdAPI
    CmdAPI -- "2. Append Event" --> ES
    ES -. "3. Publish Event" .-> Projector
    Projector -- "4. Update Projection" --> ReadDB
    ReadDB -- "5. Fast Read" --> QueryAPI
    QueryAPI -- "6. Return DTO" --> Client
```

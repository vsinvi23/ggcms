...
In Falcon, the private key is a "good" basis for an NTRU lattice (vectors that are short and orthogonal). The public key is a "bad" basis for the same lattice (vectors that are long and highly skewed). 

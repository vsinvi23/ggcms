...
```
     ...
     +--------------------------------------------------+
          │                                        ▲
          │ 1. Trigger Search                      │ 4. Structured Results
          ▼                                        │
+-------------------+                    +------------------+
...
The following Python script implements a self-contained multi-agent swarm. The coordinator orchestrates the data handoff, transforming raw, unstructured external search data into a highly polished, professional report.

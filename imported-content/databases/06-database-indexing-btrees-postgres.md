...
1. **Bad Cache Locality:** Binary trees have a "fan-out" (number of children per node) of exactly 2. To store 1,000,000 rows, a binary tree requires a depth of approximately $\log_2(1,000,000) \approx 20$ levels.

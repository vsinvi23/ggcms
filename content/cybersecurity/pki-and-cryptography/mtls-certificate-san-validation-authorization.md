---
title: "Mutual TLS: Closing the CA-Wide Authorization Bypass with SAN Validation"
description: "How naive mTLS deployments trust any certificate signed by the shared CA, and how to close the gap with SPIFFE-based SAN validation, ACL enforcement, and a hardened Go mTLS server using VerifyConnection."
type: "ARTICLE"
...
# Mutual TLS: Closing the CA-Wide Authorization Bypass with SAN Validation
...
2. **Enforce TLS 1.3** — TLS 1.3 encrypts the client certificate exchange during the handshake, preventing passive network observers from sniffing client certificates and mapping out your internal network topology.

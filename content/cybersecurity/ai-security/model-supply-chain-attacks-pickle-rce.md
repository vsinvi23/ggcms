...
description: "Why torch.load() and Python pickle turn model weight files into remote code execution vectors, with a working exploit, a restricted unpickler, and a safetensors migration path."

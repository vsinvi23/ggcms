...
description: "The Global Interpreter Lock does more than block CPU-bound multithreading — under heavy thread counts it can trigger thread thrashing, where OS context-switch overhead makes even I/O-bound Python code slower than single-threaded execution."
type: "ARTICLE"

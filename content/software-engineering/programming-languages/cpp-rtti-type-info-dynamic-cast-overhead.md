---
title: "C++ RTTI: The type_info Struct and Why dynamic_cast Degrades Performance"
description: "Understand how C++ Run-Time Type Information works under the hood via the vtable and std::type_info, and why dynamic_cast is disabled in performance-critical engines."
type: "ARTICLE"
...
# C++ RTTI: The type_info Struct and Why dynamic_cast Degrades Performance
...
## Visualizing the RTTI Graph Traversal

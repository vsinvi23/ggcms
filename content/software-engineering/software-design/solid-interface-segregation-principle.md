...
description: "How the Interface Segregation Principle prevents fat interfaces and NotImplementedException stubs, with a TypeScript refactor from a monolithic IMachine interface to role-based interfaces and API design implications."
type: "ARTICLE"

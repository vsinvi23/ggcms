---
title: "CAP Theorem and PACELC: Distributed Database Trade-offs"
description: "Why distributed databases must trade consistency for availability during network partitions, and why PACELC extends CAP to explain the latency/consistency trade-off during normal operation."
type: "ARTICLE"
...
# CAP Theorem and PACELC: Distributed Database Trade-offs
...
```text
    ...
    +-------------------+                      +-------------------+
    |    AP System       |                      |    CP System       |
    | Serve the data we  |                      | Refuse the read/   |
    | have, even if stale|                      | write to prevent   |
    |                     |                      | staleness           |
    +-------------------+                      +-------------------+
```

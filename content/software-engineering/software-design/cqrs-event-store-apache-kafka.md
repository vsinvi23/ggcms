---
title: "CQRS Event Store with Apache Kafka Log Segments"
description: "Why a single database for both operational writes and analytical reads creates contention and destroys audit history, and how Kafka's append-only log segments serve as a high-throughput CQRS event store."
type: "ARTICLE"
...
# CQRS Event Store with Apache Kafka Log Segments

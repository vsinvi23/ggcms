...
- Name: auth.spec.ts >> Authentication >> login page renders email and password fields
- Location: specs\auth.spec.ts:25:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8081/auth
Call log:
  - navigating to "http://localhost:8081/auth", waiting until "load"

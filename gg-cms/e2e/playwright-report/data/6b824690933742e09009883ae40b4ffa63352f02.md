...
- Name: dashboard.spec.ts >> Dashboard >> unauthenticated user is redirected from /articles
- Location: specs\dashboard.spec.ts:82:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8081/articles
Call log:
  - navigating to "http://localhost:8081/articles", waiting until "load"

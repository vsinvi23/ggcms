# GG-CMS Release Archive — v1.0.7 (test)

- **Target Environment**: test
- **Release Version**: v1.0.7
- **Build Timestamp**: 2026-09-17T16:23:12Z
- **Git Commit**: ce55aa6
...
```
ce55aa6 fix(routing): match header nav tabs to exact paths (/explore, /articles, /courses) and handle fallback category/topic routing gracefully

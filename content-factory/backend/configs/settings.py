...
class Settings(BaseSettings):
    ...
    gemini_model_planner: str = Field(default="gemini-2.5-flash", validation_alias="GEMINI_MODEL_PLANNER")
    gemini_model_researcher: str = Field(default="gemini-2.5-flash", validation_alias="GEMINI_MODEL_RESEARCHER")
    gemini_model_writer: str = Field(default="gemini-2.5-pro", validation_alias="GEMINI_MODEL_WRITER")
    gemini_model_reviewer: str = Field(default="gemini-2.5-flash", validation_alias="GEMINI_MODEL_REVIEWER")

...
**Status:** SUPERSEDED — see [`SLAD_AI_CONTENT_FACTORY.md`](SLAD_AI_CONTENT_FACTORY.md), the consolidated master reference.
...
> `SLAD_AI_CONTENT_FACTORY.md` §19 (Immediate Next Steps, item 2). Do not use
